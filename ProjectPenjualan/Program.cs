...
namespace ProjectPenjualan
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (nomorMenu)
                {
                    case 1:
                        TambahPenjualan();
                        break;//menambahkan penjualan

                    case 2:
                        TampilPenjualan();
                        break;//menampilkan data penjualan
        ...
        static void TampilPenjualan()
        {
            ...
            {
                Console.WriteLine("{0}. {1}, {2}, {3}, {4}, {5}", i, pnj.Nota, pnj.Tanggal, pnj.Cust, pnj.Jenis, pnj.TotalNota); //menampilkan data nota penjualan
                i++;
            }
